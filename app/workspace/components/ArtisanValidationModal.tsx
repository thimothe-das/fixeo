...
interface ArtisanValidationModalProps {
  open: boolean;
...
export function ArtisanValidationModal({
  open,
  onOpenChange,
  validationAction,
  artisanName,
}: ArtisanValidationModalProps) {
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="text-center py-12">
            ...
            <p className="text-sm text-[#717171] mt-2">
              L'artisan n'a pas encore validé l'intervention
            </p>
          </div>
        </DialogContent>
      </Dialog>
        ...
        <div className="space-y-6 mt-4">
          ...
          <div className="flex items-center gap-3 pb-4 border-b border-[#EBEBEB]">
            ...
            <div>
              <p className="font-semibold text-[#222222]">
                {artisanName || validationAction.actor?.name || "Artisan"}
              </p>
          ...
          {validationAction.validationNotes && (
            <div>
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-[#EBEBEB]">
