  ...
  await db.insert(clientProfiles).values([
    {
      ...
      addressCity: "Paris",
      addressCitycode: "75101",
      addressCoordinates: "48.8566,2.3522",
    },
    {
      userId: client2.id,
      firstName: "Pierre",
      ...
      addressStreet: "Cours Vitton",
      addressPostcode: "69006",
      addressCity: "Lyon",
      addressCitycode: "69006",
      addressCoordinates: "45.7640,4.8357",
    },
    {
      userId: client3.id,
      firstName: "Sophie",
      ...
      addressCitycode: "13001",
      addressCoordinates: "43.2965,5.3698",
    },
    {
      userId: client4.id,
      firstName: "Lucas",
      ...
      addressCitycode: "31000",
      addressCoordinates: "43.6047,1.4442",
    },
    {
      userId: client5.id,
      firstName: "Julie",
      ...
      addressCity: "Nice",
      addressCitycode: "06000",
      addressCoordinates: "43.7034,7.2663",
    },
  ]);
  ...
  await db.insert(professionalProfiles).values([
    {
      ...
      serviceAreaPostcode: "75000",
      serviceAreaCoordinates: "48.8566,2.3522",
    ...
    },
    {
      ...
      serviceAreaPostcode: "69000",
      serviceAreaCoordinates: "45.7640,4.8357",
    ...
    },
    {
      ...
      serviceAreaPostcode: "13000",
      serviceAreaCoordinates: "43.2965,5.3698",
    ...
    },
    {
      ...
      serviceAreaCoordinates: "43.6047,1.4442",
    ...
    },
    {
      ...
      serviceAreaCoordinates: "43.7034,7.2663",
  ...
  const requests = await db
    ...
    .values([
      // 1. AWAITING_ESTIMATE - Plomberie
      {
        ...
        locationCity: "Paris",
        locationCoordinates: "48.8566,2.3522",
      ...
      // 2. AWAITING_ESTIMATE - Électricité
      {
        ...
        location: "42 Cours Vitton, 69006 Lyon",
        locationHousenumber: "42",
        locationStreet: "Cours Vitton",
        locationPostcode: "69006",
        locationCity: "Lyon",
        locationCoordinates: "45.7640,4.8357",
        photos: JSON.stringify([
      ...
      // 3. AWAITING_ESTIMATE_ACCEPTATION - Peinture
      {
        ...
        locationCoordinates: "43.2965,5.3698",
        photos: JSON.stringify([
      ...
      // 4. AWAITING_ESTIMATE_ACCEPTATION - Menuiserie
      {
        ...
        locationCoordinates: "43.6047,1.4442",
        photos: JSON.stringify([
      ...
      // 5. AWAITING_ASSIGNATION - Plomberie
      {
        ...
        locationCity: "Nice",
        locationCoordinates: "43.7034,7.2663",
        photos: JSON.stringify([
          "https://images.unsplash.com/photo-1607472586893-edb57bdc0e39?w=800&auto=format&fit=crop",
        ]),
